...
def dendrit(neurons, number):
    sum = 0*int(neurons[0].work(number)) + 1*int(neurons[1].work(number)) + 2*int(neurons[2].work(number)) + 3*int(neurons[3].work(number)) + 4*int(neurons[4].work(number)) + 5*int(neurons[5].work(number)) + 6*int(neurons[6].work(number)) + 7*int(neurons[7].work(number)) + 8*int(neurons[8].work(number)) + 9*int(neurons[9].work(number))
    print(sum)
